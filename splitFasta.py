...
for rec in recs: # iterate through multi fasta 
	newfile = os.path.abspath(args.out + "/" + rec.id + ".fasta" ) # make the name of the output file
	SeqIO.write(rec, newfile, "fasta") # write this record "rec" to an output file "newfile" in this "fasta" format 
