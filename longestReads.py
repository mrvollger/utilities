...
parser.add_argument("-o", "--outbam",help="name of outbam, defulats to topLength.bam", default="topLength.bam" )
parser.add_argument("--percent", "-p", help="percent of reads to grab", type=float, default=0.1 )
...
for i in range(1,11):
    ...
    print( "{}%-{}%: {}-{}".format((i-1)*10,i*10,lengths[posStart],lengths[posEnd]) )
